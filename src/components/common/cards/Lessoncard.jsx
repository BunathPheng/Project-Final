  ...
  return (
    <Link to={`${convert}`}>
      <div className="max-w-[430px] max-h-[261px] rounded-tr-3xl rounded-bl-3xl relative group">
        <img
          className="rounded-tr-3xl rounded-bl-3xl brightness-50 w-[400px] md:h-[250px] object-cover transition-transform duration-300 group-hover:scale-105 group-hover:brightness-75"
          src={pic}
          alt="champion"
        />
